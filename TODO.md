...
Purpose: Active tasks and future ideas.
...
- [ ] Dark mode toggle UI (CSS already supports themes)
- [ ] Mermaid diagrams for flowcharts
- [ ] forms and Stimulus for forms/calculators

### Later

- [ ] Jekyll generator plugin for cleaner fingerprinting syntax
- [ ] Hand-drawn icons to replace Simple Icons
- [ ] AWS S3/CloudFront deployment option
